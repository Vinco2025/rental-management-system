    ...
    <div class="max-w-3xl mx-auto px-4 py-10">
        ...
        <div class="mb-8">
            <nav class="flex items-center gap-2 text-sm text-slate-400 mb-3">
                ...
                <span class="text-slate-600">Add New Room</span>
            </nav>
            <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Add New Room</h1>
            <p class="text-slate-500 mt-1 text-sm">Fill in the details below to register a new room.</p>
        </div>
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. 101"
                            class="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-800 placeholder-slate-400 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition @error('room_number') border-red-400 bg-red-50 @enderror"
                        >
                        @error('room_number')
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. 1"
                            min="1"
                            class="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-800 placeholder-slate-400 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition @error('floor') border-red-400 bg-red-50 @enderror"
                        >
                        @error('floor')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                min="0"
                                step="0.01"
                                class="w-full rounded-lg border border-slate-300 bg-white pl-8 pr-3.5 py-2.5 text-sm text-slate-800 placeholder-slate-400 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition @error('monthly_rate') border-red-400 bg-red-50 @enderror"
                            >
                        </div>
                        @error('monthly_rate')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="max_occupants"
                            id="max_occupants"
                            value="{{ old('max_occupants') }}"
                            placeholder="e.g. 2"
                            min="1"
                            class="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-800 placeholder-slate-400 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition @error('max_occupants') border-red-400 bg-red-50 @enderror"
                        >
                        @error('max_occupants')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        >
                            @foreach (['vacant', 'occupied', 'under_maintenance', 'reserved'] as $s)
                                <option value="{{ $s }}" {{ old('status', 'vacant') === $s ? 'selected' : '' }}>
