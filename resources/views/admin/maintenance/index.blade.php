...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold" style="color:#3D2314;">Maintenance Requests</h1>
        <p class="text-sm mt-1" style="color:#7A5542;">All submitted maintenance and repair requests</p>
    </div>
    ...
    <table class="w-full text-sm">
        <thead>
            <tr style="background:#FDF8F4;">
                ...
                <th class="text-left px-4 py-3 font-semibold" style="color:#3D2314;">Room</th>
        ...
        <tbody>
            ...
            <tr style="border-top:1px solid #E8DDD4;">
                ...
                <td class="px-4 py-3" style="color:#7A5542;">{{ $request->tenant->full_name }}</td>
                <td class="px-4 py-3" style="color:#7A5542;">Room {{ $request->room->room_number }}</td>
                <td class="px-4 py-3">
                ...
                <td class="px-4 py-3">
                    <a href="{{ route('admin.maintenance.show', $request) }}" class="text-sm font-medium" style="color:#C2622A;">View</a>
                </td>
            </tr>
            @empty
            <tr>
                <td colspan="7" class="px-4 py-12 text-center">
                    ...
                    <p class="mt-2 text-sm" style="color:#7A5542;">No maintenance requests yet.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
